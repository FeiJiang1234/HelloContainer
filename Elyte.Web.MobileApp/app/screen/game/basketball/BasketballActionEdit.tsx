...
const BasketballActionEditScreen = ({ navigation, route }) => {
    useGoBack();
    ...
    const handleGameLogClick = () => navigation.navigate(routes.BasketballLog, { gameId, gameCode, isOfficiate });
...
export default BasketballActionEditScreen;
