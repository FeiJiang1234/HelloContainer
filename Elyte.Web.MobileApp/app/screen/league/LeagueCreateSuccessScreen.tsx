...
export default function LeagueCreateSuccessScreen({ navigation, route }) {
        ...
        <ElScrollContainer>
            ...
            <Flex mb={2} align="center">
                <ElBody mb={2} textAlign="center">
                    You have successfully created a new league!
                </ElBody>
            ...
            <ElButton
                onPress={() => navigation.navigate(routes.LeagueProfile, { id: id })}
