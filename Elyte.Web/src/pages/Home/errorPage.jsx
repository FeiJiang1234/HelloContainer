...
const useStyles = makeStyles(theme => ({
    ...
    image: {
        flex: 1,
        backgroundImage: `url(/images/503.png)`,
        ...
        <Container maxWidth="xs" className={classes.root}>
            <Box className={`${classes.container} ${classes.image}`}>
                ...
                <Box className="title" textAlign="center">
                    <ElTitle large>503</ElTitle>
                    <ElTitle large>Service Unavailable</ElTitle>
                    <ElTitle sub>The service is not availble. Please try again later</ElTitle>
                </Box>
            </Box>
